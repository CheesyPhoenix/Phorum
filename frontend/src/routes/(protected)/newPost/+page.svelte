...
<form on:submit|preventDefault={submit} class="p-2 ml-2">
	...
	<button
		...
		class="mt-4 bg-blue-700 rounded-lg p-2 pt-1 pb-1 disabled:opacity-50 disabled:bg-slate-700 hover:bg-blue-500 duration-150"
		>Post</button
	>
</form>
